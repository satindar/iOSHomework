...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.bounds.size.height < self.bounds.size.width) radius = self.bounds.size.height/2;
    radius *= self.scale;
...
#define MOUTH_SMILE 0.25
    ...
    CGContextAddCurveToPoint(context, mouthCP1.x, mouthCP2.y, mouthCP2.x, mouthCP1.y, mouthEnd.x, mouthEnd.y);
    CGContextStrokePath(context);
}
